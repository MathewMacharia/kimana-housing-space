...
const ListingCard: React.FC<ListingCardProps> = ({ listing, onClick, variant = 'grid' }) => {
  ...
  return (
    <div
      onClick={onClick}
      className={`${containerClass} bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-sm border border-slate-100 dark:border-slate-800 active:scale-[0.98] transition-all cursor-pointer group`}
    >
      <div className="relative h-48 overflow-hidden bg-slate-200 dark:bg-slate-800">
        ...
        <div className="absolute top-3 left-3 flex gap-2">
          <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur px-2 py-1 rounded-lg text-[9px] font-black text-blue-600 dark:text-blue-400 shadow-sm border border-blue-50 dark:border-blue-900/30">
      ...
      <div className="p-4 space-y-2">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-slate-50 dark:border-slate-800">
          <span className={`text-[8px] font-black px-2 py-1 rounded-lg uppercase tracking-widest ${listing.isVacant
