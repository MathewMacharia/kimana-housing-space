...
const App: React.FC = () => {
  ...
  const renderExploreContent = () => {
    if (exploringTown) {
      const townAreas = LOCATIONS_HIERARCHY[exploringTown as keyof typeof LOCATIONS_HIERARCHY] || [];
      return (
        <div className="space-y-6 animate-in slide-in-from-right duration-500">
          <div className="flex items-center gap-4 mb-2">
            <button onClick={() => setExploringTown(null)} className="w-10 h-10 rounded-full bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-400 active:scale-90 transition-transform shadow-sm">
          ...
          <div className="grid grid-cols-1 gap-2">
            {townAreas.map(area => (
              <button key={area} onClick={() => handleSelectExploreArea(area)} className="w-full p-5 bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 flex items-center justify-between active:scale-[0.98] transition-all shadow-sm group">
    ...
    return (
      <div className="space-y-6 animate-in fade-in duration-500">
        ...
        <div className="grid grid-cols-1 gap-4">
          <button onClick={() => setExploringTown('Kimana')} className="relative overflow-hidden group h-40 rounded-[2.5rem] bg-blue-600 shadow-xl shadow-blue-100 dark:shadow-none active:scale-95 transition-all text-left">
            ...
            <div className="relative h-full p-8 flex flex-col justify-between">
              <div className="w-12 h-12 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center text-white text-xl"><i className="fas fa-mountain"></i></div>
          ...
          <button onClick={() => setExploringTown('Loitokitok')} className="relative overflow-hidden group h-40 rounded-[2.5rem] bg-slate-800 shadow-xl shadow-slate-200 dark:shadow-none active:scale-95 transition-all text-left">
            ...
            <div className="relative h-full p-8 flex flex-col justify-between">
              <div className="w-12 h-12 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center text-white text-xl"><i className="fas fa-cloud-sun"></i></div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button onClick={() => setExploringTown('Illasit')} className="h-28 rounded-[2rem] bg-slate-100 dark:bg-slate-900 flex flex-col justify-center p-6 border border-slate-200 dark:border-slate-800 active:scale-95 transition-all">
              <h4 className="text-lg font-black text-slate-800 dark:text-white">Illasit</h4>
              <p className="text-[8px] font-black uppercase tracking-widest text-slate-400">Border Zone</p>
            </button>
            <button onClick={() => setExploringTown('Simba Cement')} className="h-28 rounded-[2rem] bg-slate-100 dark:bg-slate-900 flex flex-col justify-center p-6 border border-slate-200 dark:border-slate-800 active:scale-95 transition-all">
              <h4 className="text-lg font-black text-slate-800 dark:text-white">Simba</h4>
              <p className="text-[8px] font-black uppercase tracking-widest text-slate-400">Industry Zone</p>
            </button>
          </div>
        </div>
      </div>
